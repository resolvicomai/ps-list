...
- The `args` property contains the command-line arguments, excluding the executable path or command name
...
The `cmd`, `args`, `cpu`, `memory`, `uid`, `path`, and `startTime` properties are not available on Windows.
